 ...
 * Mirror: server.py – Pydantic models must stay in sync with these schemas.
 * When adding/removing/renaming a field there, update this file to match.
 */
...
// ---------------------------------------------------------------------------
// CommunityTier — one resolution tier of the Leiden partition
// ---------------------------------------------------------------------------
